...
import {Collapse, Divider, Icon, Layout, Menu} from 'antd';
                            ...
                            <div id="1" style={{display: "block", padding: 24, background: '#fff', minHeight: '87vh'}}>
                                <Collapse bordered={false} disabled={false}>
                                    <Panel header="排版前选项含义" key="4" style={customPanelStyle}>
                                        ...
                                        <h3>清理无实例样式</h3>
                                        <p> 多人合并写文档，或者从其他文档中复制内容过来时，带了很多样式，导致样式侧边栏中很难找到想要的样式，不方便编辑。</p>
                                        <p> 清理无实例样式将在排版完成后将没有用到的样式清理掉，方便文档的进一步编辑。
                                        </p>
                                    </Panel>
                            ...
                            <div id="3" style={{display: "none", padding: 24, background: '#fff', minHeight: '87vh'}}>
                                <Collapse bordered={false} disabled={false}>
                                    ...
                                    <Panel header="排版结果中，目录中的页码不正确，如何处理？" key="9" style={customPanelStyle}>
                                        <p> 目录页码是排版前的文字所在的页码，排版后会发生变化，考虑到自动排版后都需要人工检查再处理，这往往会导致页码变化，所以没有更新目录页码。 </p>
                                        <p> 具体处理方法：下载后用Microsoft Office Word打开，选中目录，按F9手动刷新就。
                                        </p>
                                    </Panel>
                                    ...
                                    <Panel header="上传文档生成方案" key="12" style={customPanelStyle}>
                                        <p> 排版方案主要由排版选项和排版模板组成，排版模板可以通过上传已排版好的文档自动分析其中的格式信息，生成排版用的模板，同时使用默认的排版选项 </p>
                                        <p> 排版选项自定义的功能还在开发中。
                                        </p>
                                    </Panel>
                                    <Panel header="Word灵感百宝箱与本网站" key="13" style={customPanelStyle}>
                                        <p> Word灵感百宝箱是Word插件形式的早期作品，是国内外通用型Word插件中功能最多的插件，未来将被修改为本网站的客户端 </p>
                                        <p> 请关注本网站的最新动态。
                                        </p>
                                    </Panel>
                                </Collapse>
