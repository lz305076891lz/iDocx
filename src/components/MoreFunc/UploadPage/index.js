...
import {morefuncStart, changeUploadFileList } from '../../../actions/morefunc';
...
class UploadPage extends React.Component {
  state = {
    ...
    handleMorefuncClick = (e) => {
      ...
      this.props.morefuncStart(this.getSuccessList().map(file => file.response.id), optioninf, coverinf);
    }
      ...
      <div>
        <div className={styles['upload-file-container']}>
          <FileUpload
            ...
            loading={this.props.isMorefuncing}
      ...
      <div className={styles['option-info-fmtclear']} hidden = {prtype != 2}>
        ...
        <div className={styles['btn-wrapper']}>
          <Button
            ...
            onClick={this.handleMorefuncClick}
            loading={this.props.isMorefuncing}>
            {showtitle}
          </Button>
        </div>
...
const mapState = (state) => {
  ...
  const page = state.morefunc.upload;
  return {
    user_id,
    ...page,
  };
